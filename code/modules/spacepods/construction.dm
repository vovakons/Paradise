...
/obj/structure/spacepod_frame2/Initialize(mapload)
	. = ..()
	bound_width = 64
	bound_height = 64
...
/obj/structure/spacepod_frame2/Destroy()
	QDEL_NULL(construct)
	return ..()

/obj/structure/spacepod_frame2/attackby(obj/item/I, mob/user, params)
	if(user.a_intent == INTENT_HARM || !construct || !construct.action(I, user))
		return ..()
	add_fingerprint(user)
	return ATTACK_CHAIN_BLOCKED_ALL

/obj/structure/spacepod_frame2/attack_hand()
	return
